...
const SaidBar = () => {
  ...
  return (
    <>
      <div className="bg-yellow-300 cursor-pointer active:scale-90 hover:bg-yellow-400 shadow-lg text-4xl p-4 mx-auto  w-25 rounded-md">
        <AiOutlineAlignLeft
          onClick={handleClick}
      ...
      <div
        ref={sidebarRef}
        className="fixed  top-0 left-0 h-screen bg-yellow-100 w-0 overflow-hidden transition-width duration-500"
      >
        ...
        <div className="  p-6">
          <div className="flex gap-3">
            <img
              ...
              src="https://play-lh.googleusercontent.com/Uxu2muzP1mjgV2J8vh2q5HVGJyphJYqMhibsA5pgO7viMBwpk-OGin1IOYvGesE7jds"
              alt=""
            />
            <div className="">
          ...
          <button className="border border-white active:scale-90 hover:bg-yellow-400  px-2 rounded-md mt-5">
            LOGIN
          </button>
